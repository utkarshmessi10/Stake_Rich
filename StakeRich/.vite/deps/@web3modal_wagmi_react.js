...
} from "./chunk-2HEA5M4B.js";
import {
  y
} from "./chunk-5Y7BR324.js";
...
var Web3Modal = class extends Web3ModalScaffold {
  constructor(options) {
    ...
    const connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        const siweParams = await ((_b = siweConfig == null ? void 0 : siweConfig.getMessageParams) == null ? void 0 : _b.call(siweConfig));
        if (((_c = siweConfig == null ? void 0 : siweConfig.options) == null ? void 0 : _c.enabled) && typeof (provider == null ? void 0 : provider.authenticate) === "function" && siweParams && Object.keys(siweParams || {}).length > 0) {
          const { SIWEController, getDidChainId, getDidAddress } = await import("./exports-VVXRRPWP.js");
          ...
          const signedCacao = (_d = result == null ? void 0 : result.auths) == null ? void 0 : _d[0];
          if (signedCacao) {
    ...
    this.subscribeShouldUpdateToAddress((newAddress) => {
      ...
      if (newAddress) {
        ...
        const connector = (_a = connections[0]) == null ? void 0 : _a.connector;
        if (connector) {
  ...
  async syncAccount({ address, isConnected, chainId, connector, addresses }) {
    ...
    const isAuthConnecor = (connector == null ? void 0 : connector.id) === ConstantsUtil2.AUTH_CONNECTOR_ID;
    if (isConnected && address && chainId) {
      ...
      if (!isAuthConnecor && (addresses == null ? void 0 : addresses.length)) {
    ...
    if (typeof window !== "undefined" && connector) {
      ...
      provider.onSetPreferredAccount(({ address, type }) => {
        ...
        this.syncAccount({
          address,
          isConnected: true,
          chainId: NetworkUtil.caipNetworkIdToNumber((_a = this.getCaipNetwork()) == null ? void 0 : _a.id),
          connector
        });
      });
    }
